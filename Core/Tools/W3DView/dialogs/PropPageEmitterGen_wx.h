...
class PropPageEmitterGenBase : public wxDialog
{
public:
    PropPageEmitterGenBase() {}
    PropPageEmitterGenBase(wxWindow *parent)
    {
        Create(parent);
    }
    ...
    {
        if (!wxXmlResource::Get()->LoadDialog(this, parent, "IDD_PROP_PAGE_EMITTER_GEN")) {
            return false;
        }
        ...
        m_idc_particle_lifetime_edit = XRCCTRL(*this, "IDC_PARTICLE_LIFETIME_EDIT", wxTextCtrl);
        m_idc_particle_lifetime_spin = XRCCTRL(*this, "IDC_PARTICLE_LIFETIME_SPIN", wxSpinButton);
        ...
        m_idc_particle_lifetime_check = XRCCTRL(*this, "IDC_PARTICLE_LIFETIME_CHECK", wxCheckBox);
        m_idc_static_8 = XRCCTRL(*this, "IDC_STATIC", wxStaticText);
        m_idc_render_mode_combo = XRCCTRL(*this, "IDC_RENDER_MODE_COMBO", wxComboBox);
...
protected:
    ...
    wxTextCtrl *m_idc_particle_lifetime_edit;
    wxSpinButton *m_idc_particle_lifetime_spin;
    ...
    wxCheckBox *m_idc_particle_lifetime_check;
    wxStaticText *m_idc_static_8;
    wxComboBox *m_idc_render_mode_combo;
};

// Derived class for event handlers and custom logic
class PropPageEmitterGen : public PropPageEmitterGenBase
{
public:
