...
// Note: ##__VA_ARGS__ is a GNU extension (also works on modern MSVC 2015+) that removes
// the preceding comma when __VA_ARGS__ is empty, allowing format strings without arguments.
