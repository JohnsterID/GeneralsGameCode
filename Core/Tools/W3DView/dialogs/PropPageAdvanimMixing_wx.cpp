...
#include "PropPageAdvanimMixing_wx.h"
...
PropPageAdvanimMixing::PropPageAdvanimMixing(wxWindow *parent)
    : PropPageAdvanimMixingBase(parent)
{
    // Initialize dialog
...
void PropPageAdvanimMixing::OnOK(wxCommandEvent &event)
{
    // Validate and close
...
void PropPageAdvanimMixing::OnCancel(wxCommandEvent &event)
{
