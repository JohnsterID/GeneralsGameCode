...
class AddToLineupBase : public wxDialog
{
public:
    AddToLineupBase() {}
    AddToLineupBase(wxWindow *parent)
    {
        Create(parent);
    }
    ...
    {
        if (!wxXmlResource::Get()->LoadDialog(this, parent, "IDD_ADD_TO_LINEUP")) {
            return false;
        }

        // Get references to controls
        m_idc_object = XRCCTRL(*this, "IDC_OBJECT", wxComboBox);
...
class AddToLineup : public AddToLineupBase
{
public:
    AddToLineup(wxWindow *parent);
