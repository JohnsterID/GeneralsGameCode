...
class RenameAggregateBase : public wxDialog
{
public:
    RenameAggregateBase() {}
    RenameAggregateBase(wxWindow *parent)
    {
        Create(parent);
    }
    ...
    {
        if (!wxXmlResource::Get()->LoadDialog(this, parent, "IDD_RENAME_AGGREGATE")) {
            return false;
        }
...
class RenameAggregate : public RenameAggregateBase
{
public:
    RenameAggregate(wxWindow *parent);
