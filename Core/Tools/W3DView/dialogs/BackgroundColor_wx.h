...
class BackgroundColorBase : public wxDialog
{
public:
    BackgroundColorBase() {}
    BackgroundColorBase(wxWindow *parent)
    {
        Create(parent);
    }
    ...
    {
        if (!wxXmlResource::Get()->LoadDialog(this, parent, "IDD_BACKGROUND_COLOR")) {
            return false;
        }
...
class BackgroundColor : public BackgroundColorBase
{
public:
    BackgroundColor(wxWindow *parent);
