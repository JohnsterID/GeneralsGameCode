...
/**
 * DirectX 9 implementation of the graphics device interface.
 * 
 * This class uses native DirectX 9 types (D3DLIGHT9, D3DCAPS9, etc.)
 * without any conditional compilation or typedefs.
 */
class DX9Device : public IGraphicsDevice
{
public:
    DX9Device();
    virtual ~DX9Device();
    ...
    // DX9-specific accessors
    IDirect3DDevice9* Get_D3D9_Device() const { return m_d3dDevice; }
    IDirect3D9* Get_D3D9_Interface() const { return m_d3d; }

private:
    IDirect3D9* m_d3d;
    IDirect3DDevice9* m_d3dDevice;
    DX8Caps* m_caps;  // Will be renamed to IGraphicsCaps in future
    bool m_initialized;
