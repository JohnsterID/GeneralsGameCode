...
class ParticleRotationKeyBase : public wxDialog
{
public:
    ParticleRotationKeyBase() {}
    ParticleRotationKeyBase(wxWindow *parent)
    {
        Create(parent);
    }
    ...
    {
        if (!wxXmlResource::Get()->LoadDialog(this, parent, "IDD_PARTICLE_ROTATION_KEY")) {
            return false;
        }
        ...
        m_idc_rotation_edit = XRCCTRL(*this, "IDC_ROTATION_EDIT", wxTextCtrl);
        m_idc_rotation_spin = XRCCTRL(*this, "IDC_ROTATION_SPIN", wxSpinButton);
...
protected:
    ...
    wxTextCtrl *m_idc_rotation_edit;
    wxSpinButton *m_idc_rotation_spin;
