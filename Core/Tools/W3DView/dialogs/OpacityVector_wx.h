...
class OpacityVectorBase : public wxDialog
{
public:
    OpacityVectorBase() {}
    OpacityVectorBase(wxWindow *parent)
    {
        Create(parent);
    }
    ...
    {
        if (!wxXmlResource::Get()->LoadDialog(this, parent, "IDD_OPACITY_VECTOR")) {
            return false;
        }
        ...
        m_idc_slider_y = XRCCTRL(*this, "IDC_SLIDER_Y", wxSlider);
        m_idc_static_5 = XRCCTRL(*this, "IDC_STATIC", wxStaticText);
        m_idc_slider_z = XRCCTRL(*this, "IDC_SLIDER_Z", wxSlider);
...
protected:
    ...
    wxSlider *m_idc_slider_y;
    wxStaticText *m_idc_static_5;
    wxSlider *m_idc_slider_z;
...
class OpacityVector : public OpacityVectorBase
{
public:
    OpacityVector(wxWindow *parent);
