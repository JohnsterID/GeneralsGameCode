...
class ScaleKeyBase : public wxDialog
{
public:
    ScaleKeyBase() {}
    ScaleKeyBase(wxWindow *parent)
    {
        Create(parent);
    }
    ...
    {
        if (!wxXmlResource::Get()->LoadDialog(this, parent, "IDD_SCALE_KEY")) {
            return false;
        }
        ...
        m_idc_size_edit = XRCCTRL(*this, "IDC_SIZE_EDIT", wxTextCtrl);
        m_idc_size_spin = XRCCTRL(*this, "IDC_SIZE_SPIN", wxSpinButton);
...
protected:
    ...
    wxTextCtrl *m_idc_size_edit;
    wxSpinButton *m_idc_size_spin;
