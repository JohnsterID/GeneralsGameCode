...
class OpacityBase : public wxDialog
{
public:
    OpacityBase() {}
    OpacityBase(wxWindow *parent)
    {
        Create(parent);
    }
    ...
    {
        if (!wxXmlResource::Get()->LoadDialog(this, parent, "IDD_OPACITY")) {
            return false;
        }
...
class Opacity : public OpacityBase
{
public:
    Opacity(wxWindow *parent);
